...
\begin{figure}[h!]
\centering
\subfloat[][Layer Manager]{\includegraphics[width=0.45\textwidth]{./wxgui_layer_manager.png}}   \quad              
\subfloat[][Map Display Window]{\includegraphics[width=0.45\textwidth]{./wxgui_map_display.png}}  
